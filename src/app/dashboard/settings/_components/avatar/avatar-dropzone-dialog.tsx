...
export default function AvatarDropzoneDialog(props: PropTypes) {
    const { onChange, value, isinvalid, open, setOpen } = props;
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Upload gambar yang sesuai untuk mengubah avatar Anda</DialogDescription>
                </DialogHeader>
                <div
                    className={cn(
